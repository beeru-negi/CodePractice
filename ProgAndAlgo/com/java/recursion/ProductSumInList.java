...
/**
 * List contain values as integer and special list. Special list means it can
 * have multiple level of list We have to take the sum of values as per
 * different level. Ex= [x, [y,z,[a,b,c]],d] = x + 2*(y+z+ 3*(a+b+c)) + d
 **/
